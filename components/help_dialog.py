...
class HelpDialog(QDialog):
    ...
    def init_ui(self):
        ...
        <ol>
            ...
            <li><b>开始标注</b>：使用鼠标左键点击添加顶点，或使用辅助工具（边缘吸附、膨胀点选、SAM分割）</li>
        ...
        <ul>
            ...
            <li><b>SAM分割</b>：按 <b>S</b> 切换开关，点击图像使用AI智能分割。需要先加载SAM模型</li>
            <li><b>绘制顶点</b>：鼠标左键点击添加顶点，会显示空心红色小圆，移动鼠标时会有红色虚线连接到当前鼠标位置</li>
            <li><b>暂存当前区域</b>：按 <b>Enter</b>，会自动连接起点和最后一个点形成闭合多边形</li>
            <li><b>保存整株</b>：按 <b>Shift+Enter</b>，将所有暂存的区域保存为一个完整植株</li>
        ...
        <table border="1" style="border-collapse: collapse; width: 100%;">
            ...
            <tr>
                <td style="padding: 8px;">切换SAM分割</td>
        ...
        <ul>
            ...
            <li><b>SAM分割无法使用</b>：需要先点击「加载SAM模型」按钮加载模型文件</li>
