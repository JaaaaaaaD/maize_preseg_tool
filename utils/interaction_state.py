class InteractionStateMachine:
    ...
    FINE_TUNE_MERGE_STAGING = "fine_tune_merge_staging"
    ...
    _ALLOWED_TRANSITIONS = {
        ...
        FINE_TUNE: {
            ...
            FINE_TUNE_DELETE_VERTEX,
            FINE_TUNE_SPLIT_STAGING,
            FINE_TUNE_MERGE_STAGING,
            REMOVAL_REGION,
        },
        FINE_TUNE_ADD_VERTEX: {FINE_TUNE, FINE_TUNE_DELETE_VERTEX, FINE_TUNE_SPLIT_STAGING, FINE_TUNE_MERGE_STAGING, IDLE},
        FINE_TUNE_DELETE_VERTEX: {FINE_TUNE, FINE_TUNE_ADD_VERTEX, FINE_TUNE_SPLIT_STAGING, FINE_TUNE_MERGE_STAGING, IDLE},
        FINE_TUNE_SPLIT_STAGING: {FINE_TUNE, FINE_TUNE_ADD_VERTEX, FINE_TUNE_DELETE_VERTEX, FINE_TUNE_MERGE_STAGING, IDLE},
        FINE_TUNE_MERGE_STAGING: {FINE_TUNE, FINE_TUNE_ADD_VERTEX, FINE_TUNE_DELETE_VERTEX, FINE_TUNE_SPLIT_STAGING, IDLE},
        IGNORE_REGION: {IDLE},
